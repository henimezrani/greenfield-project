...
// this component allows you to proceed to checkout after verification of the items. there are a lot of improvements to be done and bugs to be fixed, again, due to the time management issue. have fun and sorry for the ugliness of this component!
class Checkout extends Component {
  ...
  // confirm checkout by sending the request to add the order to the database
  handleClick(event) {
  ...
  // Bind input values to the state.
  typing(event) {
    this.setState({[event.target.id]: event.target.value});
  }

  // switch between pills upon click
  togglePills(tab) {
